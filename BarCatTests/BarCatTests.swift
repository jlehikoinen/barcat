...
final class BarCatTests: XCTestCase {
    ...
    func testDuplicateHostFoundInFavoriteHosts() {
        ...
        XCTAssertTrue(barCatStore.favoriteHostsContainsDuplicates)
        XCTAssertTrue(barCatStore.favoriteHostsContains(identicalHost))
    }
    ...
    func testDuplicatePortFoundInPorts() {
        ...
        XCTAssertTrue(barCatStore.portsContains(identicalPort))
    }
}
